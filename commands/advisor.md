...
- **full**: `@advisor` is dispatched; if the question is classified FACTUAL and confidence ≥ 9, it answers on the user's behalf (auto-execute); otherwise lite flow. PREFERENCE questions always return to the user.

...
description: Grill with docs - grill-me plus domain modeling: CONTEXT.md and ADRs are created inline during the grilling, then development is dispatched. Load ONLY when the user invokes /grill-with-docs.
---

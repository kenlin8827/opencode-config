...
hero:
  name: "OpenCode"
  text: "Production Engineering Config"
  tagline: "AI Software Engineering: Layered Code Intelligence · Hard Guardrails · Specialist Swarm"
  image:
    src: /logo.svg
    alt: OpenCode Production Engineering Config
  actions:
    - theme: brand

# Test: subagent dispatched by the build orchestrator
...
opencode run --agent build --model llm-router/default "Use @tech-writer to answer: what is 1+1? Keep it very brief."
